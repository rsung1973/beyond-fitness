...
namespace CommonLib.Logger
{
    ...
    public class Logger : IDisposable , ILogger
    {
        ...
        private LogWritter _err, _nfo, _dbg, _wrn, _tra;
        ...
        public Logger()
        {
            ...
            _dbg = new LogWritter(this, "SystemLog.dbg");
            _err = new LogWritter(this, "SystemLog.err");
            _nfo = new LogWritter(this, "SystemLog.nfo");
            _wrn = new LogWritter(this, "SystemLog.wrn");
            _tra = new LogWritter(this, "SystemLog.trace");
        }
        ...
        public string LogDailyPath
        {
            get
            {
                string filePath = ValueValidity.GetDateStylePath(_path);
