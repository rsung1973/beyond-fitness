...
namespace WebHome.Controllers
{
    ...
    {
        public ExerciseGameController(IServiceProvider serviceProvider) : base(serviceProvider)
        {
        ...
        public async Task<ActionResult> CommitExerciseResultAsync(ExerciseGameViewModel viewModel)
        {
            ViewBag.ViewModel = viewModel;
