...
$.AdminCompass = {}, $.AdminCompass.options = {
    ...
    activate: function () {
        ...
        $(window).on("click", function (e) {
            var a = $(e.target);
            "i" === e.target.nodeName.toLowerCase() && (a = $(e.target).parent()), !a.hasClass("bars") && t.isOpen() && 0 === a.parents("#leftsidebar").length && (a.hasClass("js-right-sidebar") || i.fadeOut(), s.removeClass("overlay-open"))
    ...
    activate: function () {
        ...
        $(window).on("click", function (e) {
            var a = $(e.target);
            "i" === e.target.nodeName.toLowerCase() && (a = $(e.target).parent()), !a.hasClass("js-right-sidebar") && t.isOpen() && 0 === a.parents("#rightsidebar").length && (a.hasClass("bars") || i.fadeOut(), s.removeClass("open"))
        }), $(".js-right-sidebar").on("click", function () {
            s.toggleClass("open"), t.isOpen() ? i.fadeIn() : i.fadeOut()
        })
    },
    isOpen: function () {
