            ...
            $('#<%= _dialog %>').dialog({
                ...
                buttons: [{
                    ...
                    click: function () {
                        ...
                        if (sigData) {
                            $.post('<%= Url.Action("CommitSignature","Account",new { uid = _viewModel.UID }) %>', { 'Signature': sigData }, function (data) {
                                //hideLoading();
                                if (data.result) {
                                    $global.$signatureImage[0].src = sigData;
...
<script runat="server">
    ...
    UserSignatureViewModel _viewModel;
    ...
    protected override void OnInit(EventArgs e)
    {
        ...
        _viewModel = (UserSignatureViewModel)ViewBag.ViewModel;
