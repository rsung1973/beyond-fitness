                        ...
                        <form action="<%= VirtualPathUtility.ToAbsolute("~/SystemInfo/CommitLessonPrice") %>" id="pageForm" class="smart-form" method="post">
                            ...
                            <fieldset>
                                <div class="row">
                                    ...
                                    <section class="col col-4">
                                        <label class="label">教練鐘點費用(現金)</label>
                                        <label class="input">
                                            <i class="icon-append fa fa-money"></i>
                                            <input type="text" name="coachPayoff" id="coachPayoff" value="<%= _viewModel.CoachPayoff %>" maxlength="20" class="input-lg" placeholder="請輸入教練鐘點費用(現金)" />
                                        </label>
                                    </section>
                                    <section class="col col-4">
                                        <label class="label">教練鐘點費用(信用卡)</label>
                                        <label class="input">
                                            <i class="icon-append fa fa-credit-card"></i>
                                            <input type="text" name="coachPayoffCreditCard" id="coachPayoffCreditCard" value="<%= _viewModel.CoachPayoffCreditCard %>" maxlength="20" class="input-lg" placeholder="請輸入教練鐘點費用(信用卡)" />
                                        </label>
                                    </section>
                                </div>
                            </fieldset>
