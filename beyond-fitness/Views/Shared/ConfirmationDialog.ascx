    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title orange-text"><span class="glyphicon glyphicon-info-sign" aria-hidden="true"></span><span id="confirmTitle">系統訊息</span></h4>
            </div>
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-12 modal-footer">
                        <button id="btnConfirmIt" type="button" class="btn btn-system btn-sm"><span class="fa fa-link" aria-hidden="true"></span>確定</button>
