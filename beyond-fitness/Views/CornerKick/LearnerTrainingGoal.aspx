                    ...
                    <div class="goal-forms">
                            ...
                            <div class="goal-content">
                                ...
                                <div class="personal-info">
                                    <div class="row valign-wrapper">
                                        ...
                                        <div class="col s8 m10 text-box"><span class="black-t18">週期性目標</span> <span class="black-t12">
                                            <%= _model.PersonalExercisePurpose!=null
                                                    ...
                                                    : "目前暫無週期性目標，請洽詢專屬顧問幫您設計『屬於自己』的目標吧！" %></span> </div>
                                    </div>
                                </div>
                                <!-- 1 -->
                                ...
                                <p class="collection center">
                                    <span class="gray-t16">您暫無近期目標<br />
                                        快與您的體能顧問進行討論喔！</span>
                                </p>
                                <%  } %>
                            </div>
                        ...
                        <div id="test-swipe-2" class="tab-content acc-content col s12">
                            ...
                            <div class="goal-content">
                                ...
                                <img class="responsive-img nodata" src="images/nodata.png">
                                <p class="collection center">
                                    <span class="gray-t16">加油加油，與您的體能顧問合作<br />
                                        建立更多運動里程碑吧！</span>
                                </p>
                                <%  } %>
                            </div>
