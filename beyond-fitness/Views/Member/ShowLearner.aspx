        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    ...
                    <h4 class="classic-title"><span>購買上課紀錄</span></h4>
                    <!-- TABLE 1 -->
                    ...
                    <div class="tabs-section">
                        ...
                        <div class="hr1" style="margin: 5px 0px;"></div>
                        <a class="btn-system btn-medium" href="<%= VirtualPathUtility.ToAbsolute("~/Member/ListAll") %>">人員管理 <i class="fa fa-reply" aria-hidden="true"></i></a>

                        <!-- End Contact Form -->

                    </div>
                    <!-- End Post -->
                    <h4 class="classic-title"><span>PDQ問卷調查</span></h4>
                </div>
            </div>
        </div>
    </div>
