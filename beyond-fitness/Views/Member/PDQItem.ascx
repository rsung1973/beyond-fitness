...
<%  
    switch ((Naming.QuestionType)_model.QuestionType)
    {
        case Naming.QuestionType.問答題:
            Html.RenderPartial("~/Views/Member/PDQQuestionAndAnswer.ascx", _model);
            break;
        case Naming.QuestionType.單選題:
        case Naming.QuestionType.單選其他:
            Html.RenderPartial("~/Views/Member/PDQSingleChoice.ascx", _model);
            break;
        case Naming.QuestionType.多重選:
            break;
        case Naming.QuestionType.是非題:
            Html.RenderPartial("~/Views/Member/PDQYesOrNo.ascx", _model);
            break;
    } %>
