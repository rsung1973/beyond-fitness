...
<head runat="server">
    ...
    <script src="<%= basePath + "Scripts/rasterizeHTML-allinone.js" %>"></script>
...
<body>
    印表機IP:<input type="text" id="printerIP" /> <button type="button" onclick="printInvoice();">列印</button>
    <br />
<%--    <canvas id="invCanvas" width="440" height="760"></canvas>--%>
</body>
</html>
<script>
