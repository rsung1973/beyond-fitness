...
<li>
    ...
    <div class="smart-timeline-content">
        <div class="well well-sm display-inline bg-color-red">
            <p>您已於<strong> <%= _model.Lesson.ClassTime.Value.ToString("yyyy/MM/dd HH:mm") %>~<%= _model.Lesson.ClassTime.Value.AddMinutes(_model.Lesson.DurationInMinutes.Value).ToString("HH:mm") %></strong>
            ...
            <p>
                <button class="btn btn-xs btn-default" onclick="showLearnerLesson(<%= _model.Lesson.LessonID %>,true);"><i class="fa fa-gift"></i> 確認上課內容</button>
