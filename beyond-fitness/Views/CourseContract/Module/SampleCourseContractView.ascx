        ...
        <div class="well no-padding well-light" style="width: 23cm; height: 30cm">
            ...
            <div class="<%= Request["pdf"]=="1" ? "bs-example bs-example-type seal" : "bs-example bs-example-type" %>">
                <table class="table" style="font-size: 16px">
                    ...
                    <tbody>
                        <tr>
                            <td colspan="2">名稱：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;分鐘)</td>
                            <td>上課場所：</td>
                        </tr>
                        <tr>
                            <td colspan="2">專業顧問建置與諮詢費：</td>
                            <td>教練課程費：</td>
                        </tr>
                        <tr>
                            <td colspan="2">購買堂數：</td>
                            <td>專業顧問服務總費用：</td>
                        </tr>
                        <tr>
                            <td colspan="3">顧問服務使用期限：自 &nbsp;&nbsp;&nbsp;&nbsp; 起，至 &nbsp;&nbsp;&nbsp;&nbsp; 止。</td>
                        </tr>
                        <tr>
                            <td colspan="3" style="height: 2cm;">備註：</td>
                        </tr>
                    </tbody>
                </table>
                <table class="table" style="font-size: 16px">
