...
<%  if (_userProfile != null
    ...
    { %>
<li>
    <a href="#" title="合約管理"><i class="fa fa-lg fa-fw fa-file-text-o"></i><span class="menu-item-parent">合約管理</span></a>
    <ul>
        <li>
            <a href="<%= Url.Action("CreateContract","CourseContract") %>" title="新增合約"><i class="fa fa-lg fa-fw fa-file-text-o"></i>新增合約</a>
        </li>
        <li>
