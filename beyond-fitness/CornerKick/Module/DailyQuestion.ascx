...
<div class="qa-content">
    <div class="personal-info">
        <div class="row valign-wrapper">
            ...
            <div class="col s8 m10 text-box"><span class="black-t18"><%= _model.UserProfile.UserName ?? _model.UserProfile.FullName() %></span> <span class="black-t12">Hi，來點腦力激盪，答對我出的題目可以獲得點數喔！</span></div>
        </div>
    </div>
    <!-- 問題 -->
