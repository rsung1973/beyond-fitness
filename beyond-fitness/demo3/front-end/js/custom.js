...
function initMap() {
    ...
    var mapOptions = {
        scaleControl: true,
        center: new google.maps.LatLng(25.0519269, 121.55007599999999),
        zoom: 9,
...
function initMapLocation() {
    var arenaStation = new google.maps.LatLng(25.0519269, 121.55007599999999); //小巨蛋
    var oneooneStation = new google.maps.LatLng(25.0327247, 121.56294130000003); //Enhanced 101
    var sogoStation = new google.maps.LatLng(25.044656, 121.546290); //復興SOGO
...
//end function
//Start function
function initMapLocationByPlace(place) {    

    var station;

    if (place == 'arena') {
        station = new google.maps.LatLng(25.0519269, 121.55007599999999); //小巨蛋
    } else if (place == 'oneoone') {
        station = new google.maps.LatLng(25.0327247, 121.56294130000003); //Enhanced 101
    } else if (place == 'sogo') {
        station = new google.maps.LatLng(25.044656, 121.546290); //復興SOGO
    }
