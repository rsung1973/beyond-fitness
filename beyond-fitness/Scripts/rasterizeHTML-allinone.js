...
! function (a) {
    if ("object" == typeof exports && "undefined" != typeof module) module.exports = a();
        ...
        var b;
        b = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : this, b.rasterizeHTML = a()
    }
}(function () {
    var a;
    return function a(b, c, d) {
        ...
        1: [function (b, c, d) {
            ! function (e, f) {
                "function" == typeof a && a.amd ? a(["url", "css-mediaquery", "xmlserializer", "sane-domparser-error", "ayepromise", "inlineresources"], function (a, b, c, d, g, h) {
                    return e.rasterizeHTML = f(a, b, c, d, g, h)
                }) : "object" == typeof d ? c.exports = f(b("url"), b("css-mediaquery"), b("xmlserializer"), b("sane-domparser-error"), b("ayepromise"), b("inlineresources")) : e.rasterizeHTML = f(e.url, e.cssMediaQuery, e.xmlserializer, e.sanedomparsererror, e.ayepromise, e.inlineresources)
                ...
                var g = function (a) {
                    ...
                    i = function () {
                        ...
                        var c = function (a, c) {
                            ...
                            g = function (a) {
                                ...
                                c.textContent = a.textContent, b.body.appendChild(c), a.sheet = c.sheet
                            },
                            h = function (a) {
                                return "((?:^|[^.#:\\w])|(?=\\W))(" + a.join("|") + ")(?=\\W|$)"
                            },
                            i = function (a, c, e) {
                                ...
                                b(a.querySelectorAll("style")).forEach(function (a) {
                                    "undefined" == typeof a.sheet && g(a);
                                    var c = b(a.sheet.cssRules).filter(function (a) {
                                        return a.selectorText && new RegExp(i, "i").test(a.selectorText)
                                    });
                                    c.length && (c.forEach(function (a) {
                                        var b = a.selectorText.replace(new RegExp(i, "gi"), function (a, b, c) {
                                            return b + e(c)
                                        });
                        ...
                        return a.rewriteCssSelectorWith = function (a, b, c) {
                            ...
                            var b, c = a.ownerDocument.createTreeWalker(a, NodeFilter.SHOW_ELEMENT),
                                d = {},
                                e = {};
                            do b = c.currentNode.tagName.toLowerCase(), "http://www.w3.org/1999/xhtml" === c.currentNode.namespaceURI ? d[b] = !0 : e[b] = !0; while (c.nextNode());
                    ...
                    k = function (a) {
                        ...
                        var b, c = {},
                            d = function () {
                                var a = '<svg id="svg" xmlns="http://www.w3.org/2000/svg" width="10" height="10"><style>@media (max-width: 1em) { svg { background: #00f; } }</style></svg>',
                    ...
                    l = function (a, b, c, d, e) {
                        ...
                        f.executeJavascript = function (a, d) {
                            var f = g(e.document, "iframe", d.width, d.height),
                                ...
                                n = f.contentWindow.XMLHttpRequest,
                                o = b.finishNotifyingXhr(n),
                                p = b.baseUrlRespectingXhr(o, d.baseUrl);
                            return f.onload = function () {
                                m().then(o.waitForRequestsToFinish).then(l)
                            }, f.contentDocument.open(), f.contentWindow.XMLHttpRequest = p, f.contentWindow.onerror = function (a) {
                                i.push({
                        ...
                        var h = function (a, b, c) {
                            ...
                            return d.style.width = b + "px", d.style.height = c + "px", d.style.visibility = "hidden", d.style.position = "absolute", d.style.top = -1e4 - c + "px", d.style.left = -1e4 - b + "px", d.sandbox = "allow-same-origin allow-scripts", d.scrolling = "no", d
                        },
                            i = function (a, b, c) {
                            ...
                            k = function (a, b) {
                                ...
                                if (c) return c;
                                if (a.ownerDocument.querySelector(b) === a) return a;
                                throw {
                                    message: "Clipping selector not found"
                                }
                            },
                            l = function (a, b, c, d, f) {
                                var g, h, i, l, m, n, o, p, q = Math.max(a.scrollWidth, a.clientWidth),
                                    r = Math.max(a.scrollHeight, a.clientHeight);
                                return b ? (n = k(a, b), o = n.getBoundingClientRect(), g = o.top, h = o.left, i = o.width, l = o.height) : (g = 0, h = 0, i = q, l = r), p = j({
                                    width: i,
                                    height: l
                                }, c, d, f), m = e.getComputedStyle(a.ownerDocument.documentElement).fontSize, {
                                    left: h,
                                    top: g,
                                    width: p.width,
                                    height: p.height,
                            ...
                            n = function (a) {
                                ...
                                return "html" === b || "body" === b ? a.outerHTML : '<body style="margin: 0;">' + a.outerHTML + "</body>"
                            };
                        f.calculateDocumentContentSize = function (a, b) {
                            var d, f = c.defer(),
                                g = b.zoom || 1;
                            return d = i(b.width, b.height, g), e.document.getElementsByTagName("body")[0].appendChild(d), d.onload = function () {
                                var c, h = d.contentDocument;
                                try {
                                    c = l(m(a, h), b.clip, b.width, b.height, g), f.resolve(c)
                                } catch (a) {
                                    f.reject(a)
                                } finally {
                                    e.document.getElementsByTagName("body")[0].removeChild(d)
                                }
                            }, d.contentDocument.open(), d.contentDocument.write("<!DOCTYPE html>"), d.contentDocument.write(n(a)), d.contentDocument.close(), f.promise
                        }, f.parseHtmlFragment = function (a) {
                            var b = e.document.implementation.createHTMLDocument("");
                            b.documentElement.innerHTML = a;
                            var c = b.querySelector("body").firstChild;
                            if (!c) throw "Invalid source";
                            return c
                        };
                        var o = function (a, b) {
                        ...
                        f.parseHTML = function (a) {
                            var b = e.document.implementation.createHTMLDocument("");
                            return b.documentElement.innerHTML = a, o(b, a), b
                        };
                        var p = function (a) {
                            try {
                        ...
                        var q = null,
                            r = function (a, b) {
                                return "none" === b || "repeated" === b ? (null !== q && "repeated" === b || (q = Date.now()), a + "?_=" + q) : a
                            },
                            s = function (b, d) {
                        ...
                        var c, d = {},
                            ...
                            i = function () {
                                ...
                                return h(a).then(function (b) {
                                    return f(a), !b && h(e(g, !1)).then(function (a) {
                                        return a
                                    })
                                }, function () {
                                    return !1
                    ...
                    n = function (a, b, c, d, e) {
                        ...
                        var f = {},
                            g = function (a, b) {
                                var c = b || 1,
                                    d = {
                                        width: a.width,
                                        height: a.height,
                                        "font-size": a.rootFontSize
                                    };
                                return 1 !== c && (d.style = "transform:scale(" + c + "); transform-origin: 0 0;"), d
                            },
                            h = function (a) {
                                var b, c, d, e;
                                b = Math.round(a.viewportWidth), c = Math.round(a.viewportHeight), d = -a.left, e = -a.top;
                                var f = {
                                    x: d,
                                    y: e,
                                    width: b,
                            ...
                            m = function (a, c, d) {
                                ...
                                b.validateXHTML(f);
                                var m = h(c);
                                return i(m), j(m), '<svg xmlns="http://www.w3.org/2000/svg"' + l(g(c, d)) + ">" + k() + "<foreignObject" + l(m) + ">" + f + "</foreignObject></svg>"
                            };
                        return f.getSvgForDocument = function (a, b, e) {
                            return c.rewriteTagNameSelectorsToLowerCase(a), d.needsEmWorkaround().then(function (c) {
                                return c && d.workAroundWebKitEmSizeIssue(a), m(a, b, e)
                            })
                        ...
                        return g.rasterize = function (b, c, d) {
                            ...
                            return e = a.clone(d), e.inlineScripts = d.executeJs === !0, f.inlineReferences(b, e).then(function (a) {
                                return d.executeJs ? l(b, d).then(function (b) {
                                    return {
                                        element: b.document.documentElement,
                                ...
                                return k(a.element, c, d).then(function (b) {
                                    return {
                                        image: b.image,
                                        svg: b.svg,
                                        errors: a.errors
                    ...
                    p = function (a, b, c) {
                        ...
                        d.drawDocument = function () {
                            var b = arguments[0],
                                ...
                                g = b.documentElement ? b.documentElement : b;
                            return c.rasterize(g, e.canvas, f(e))
                        };
        ...
        2: [function (b, c, d) {
            ! function (b, e) {
                ...
                var a = {},
                    ...
                    c = function (a) {
                        var b = a && a.then;
                        if ("object" == typeof a && "function" == typeof b) return function () {
        ...
        6: [function (a, b, c) {
            ...
            c.SyntaxError = function (a, b) {
                ...
                try {
                    ...
                    throw new c.SyntaxError(a.message, a.offset)
                }
        ...
        9: [function (a, b, c) {
            ...
            d.CSSDocumentRule = function () {
                ...
                get: function () {
                    for (var a = [], b = 0, c = this.cssRules.length; b < c; b++) a.push(this.cssRules[b].cssText);
                    ...
                    for (var b, c, d = 0, e = "", f = ""; c = a.charAt(d) ; d++) switch (c) {
                        ...
                        case "u":
                            if ("url" === e && a.indexOf("url(", d) === d) {
                                if (b = a.indexOf(")", d + 1), b === -1) throw d + ': ")" not found';
                                d += "url(".length;
                                var g = a.slice(d, b);
            ...
            d.CSSStyleDeclaration = function () {
                ...
                setProperty: function (a, b, c) {
                    if (this[a]) {
                        ...
                        d < 0 && (this[this.length] = a, this.length++)
                ...
                set cssText(a) {
                    ...
                    var e = d.parse("#bogus{" + a + "}").cssRules[0].style,
                        f = e.length;
                    for (b = 0; b < f; ++b) c = e[b], this.setProperty(e[b], e.getPropertyValue(c), e.getPropertyPriority(c))
                }
        ...
        17: [function (a, b, c) {
            ...
            d.CSSStyleRule = function () {
                ...
                for (var b, c, e, f = 0, g = "selector", h = f, i = "", j = {
                    ...
                    case "/":
                        if ("*" === a.charAt(f + 1)) {
                            if (f += 2, b = a.indexOf("*/", f), b === -1) throw new SyntaxError("Missing */");
                            f = b + 1
                        } else i += e;
                        break;
                    case "{":
        ...
        18: [function (a, b, c) {
            ...
            d.CSSStyleSheet = function () {
                ...
                if (b < 0 || b > this.cssRules.length) throw new RangeError("INDEX_SIZE_ERR");
                ...
                if (a < 0 || a >= this.cssRules.length) throw new RangeError("INDEX_SIZE_ERR");
        ...
        19: [function (a, b, c) {
            ...
            d.CSSValue = function () { }, d.CSSValue.prototype = {
                ...
                set cssText(a) {
                    ...
                    throw new Error('DOMException: property "cssText" of "' + b + '" is readonly and can not be replaced with "' + a + '"!')
                },
                get cssText() {
                    var a = this._getConstructorName();
                    throw new Error('getter "cssText" of "' + a + '" is not implemented!')
                },
        ...
        20: [function (a, b, c) {
            ...
            d.CSSValueExpression = function (a, b) {
                ...
                if ("/" === d || "*" === d) {
                    var e, f, g = b;
                    if ("/" === d ? f = "\n" : "*" === d && (f = "*/"), e = a.indexOf(f, g + 1 + 1), e !== -1) return e = e + f.length - 1, c = a.substring(b, e + 1), {
                        idx: e,
                        text: c
                    };
                ...
                return e !== -1 && (d = a.substring(b, e + c.length), {
                    idx: e,
                    text: d
                })
        ...
        21: [function (a, b, c) {
            ...
            d.MatcherList = function () {
                ...
                set matcherText(a) {
                    for (var b = a.split(","), c = this.length = b.length, d = 0; d < c; d++) this[d] = b[d].trim()
                },
                appendMatcher: function (a) {
                    Array.prototype.indexOf.call(this, a) === -1 && (this[this.length] = a, this.length++)
                },
                deleteMatcher: function (a) {
                    var b = Array.prototype.indexOf.call(this, a);
                    b !== -1 && Array.prototype.splice.call(this, b, 1)
                }
        ...
        24: [function (a, b, c) {
            ...
            d.clone = function a(b) {
                ...
                for (var f = {
                    ...
                    var i = e[g],
                        j = c.cssRules[g] = new f[i.type],
                        k = i.style;
                    if (k) {
                        for (var l = j.style = new d.CSSStyleDeclaration, m = 0, n = k.length; m < n; m++) {
                            var o = l[m] = k[m];
                            l[o] = k[o], l._importants[o] = k.getPropertyPriority(o)
                        }
                        l.length = k.length
                    }
                    i.hasOwnProperty("keyText") && (j.keyText = i.keyText), i.hasOwnProperty("selectorText") && (j.selectorText = i.selectorText), i.hasOwnProperty("mediaText") && (j.mediaText = i.mediaText), i.hasOwnProperty("cssRules") && (j.cssRules = a(i).cssRules)
                }
                return c
            }, c.clone = d.clone
        }, {
            ...
            d.parse = function (a) {
                for (var b, c, e, f, g, h, i, j, k, l, m = 0, n = "before-selector", o = "", p = {
                    ...
                    case "'":
                        ...
                        break;
                    case "/":
                        "*" === a.charAt(m + 1) ? (m += 2, b = a.indexOf("*/", m), b === -1 ? u("Missing */") : m = b + 1) : o += l, "importRule-begin" === n && (o += " ", n = "importRule");
                        break;
                    case "@":
                    ...
                    case "(":
                        if ("value" === n)
                            ...
                            } else n = "value-parenthesis", o += l;
                        else o += l;
                        break;
                    case ")":
                        "value-parenthesis" === n && (n = "value"), o += l;
                        break;
                    case "!":
        ...
        28: [function (a, b, c) {
            ...
            var e = function (a) {
                ...
                g = function () {
                    var a = e('@font-face { font-family: "f"; src: url("f"); }');
                    return !a.length || /url\(['"]*\)/.test(a[0].cssText)
                }(),
                h = function () {
                    var a = e("a{background:url(old)}");
                    return a[0].style.setProperty("background", "url(new)", ""), a[0].style.getPropertyValue("background").indexOf("old") >= 0
                }();
            c.rulesForCssText = function (a) {
                return (f || g || h) && d && d.parse ? d.parse(a).cssRules : e(a)
            }, c.cssRulesToText = function (a) {
                return a.reduce(function (a, b) {
                    return a + b.cssText
                }, "")
            }, c.exchangeRule = function (a, b, d) {
                var e = a.indexOf(b);
                a[e] = c.rulesForCssText(d)[0]
        ...
        29: [function (a, b, c) {
            ...
            var d = a("./util"),
                ...
                n = function (a) {
                    ...
                    return Array.prototype.filter.call(b, function (a) {
                        return !a.attributes.type || "text/css" === a.attributes.type.value
                    })
                };
            ...
            var o = function (a, b) {
                ...
                r = function (a) {
                    ...
                    return Array.prototype.filter.call(b, function (a) {
                        return a.attributes.rel && "stylesheet" === a.attributes.rel.value && (!a.attributes.type || "text/css" === a.attributes.type.value)
                    })
                };
        ...
        31: [function (a, b, c) {
            ...
            var d = a("./util"),
                e = function (a, b) {
                    var c = null;
                    a.hasAttribute("src") ? c = a.getAttribute("src") : a.hasAttributeNS("http://www.w3.org/1999/xlink", "href") ? c = a.getAttributeNS("http://www.w3.org/1999/xlink", "href") : a.hasAttribute("href") && (c = a.getAttribute("href"));
                    var e = d.getDocumentBaseUrl(a.ownerDocument),
                        f = d.clone(b);
                ...
                f = function (a) {
                    return a.filter(function (a) {
                        var b = null;
                        return a.hasAttribute("src") ? b = a.getAttribute("src") : a.hasAttributeNS("http://www.w3.org/1999/xlink", "href") ? b = a.getAttributeNS("http://www.w3.org/1999/xlink", "href") : a.hasAttribute("href") && (b = a.getAttribute("href")), null !== b && !d.isDataUri(b)
                    })
                },
                g = function (a) {
            ...
            c.inline = function (a, b) {
                var c = h(a.getElementsByTagName("img")),
                    i = h(a.getElementsByTagName("image")),
                    j = g(a.getElementsByTagName("input"));
                c = c.concat(i), c = c.concat(j);
                var k = f(c);
                return d.collectAndReportErrors(k.map(function (a) {
                    return e(a, b).then(function (b) {
                        a.attributes.src ? a.attributes.src.value = b : a.attributes["xlink:href"] ? a.attributes["xlink:href"].value = b : a.attributes.href && (a.attributes.href.value = b)
                    })
                }))
            }
        }, {
        ...
        39: [function (a, b, c) {
            var d = function (a) {
                ...
                i = function (a, b) {
                    var c = Array.prototype.map.call(a.attributes || a.attrs, function (a) {
                        return a.name
                    }).indexOf("xmlns") >= 0;
                    return c || !b && a.namespaceURI === a.parentNode.namespaceURI ? "" : ' xmlns="' + a.namespaceURI + '"'
                },
                j = function (a) {
                    return Array.prototype.map.call(a.childNodes, function (a) {
                        return o(a)
                ...
                k = function (a, b) {
                    var c = "<" + h(a);
                    return c += i(a, b), Array.prototype.forEach.call(a.attributes || a.attrs, function (a) {
                        c += g(a)
                    }), a.childNodes.length > 0 ? (c += ">", c += j(a), c += "</" + h(a) + ">") : c += "/>", c
                },
                l = function (a) {
                ...
                o = function (a, b) {
                    var c = b && b.rootNode;
                    return "#document" === a.nodeName || "#document-fragment" === a.nodeName ? j(a) : a.tagName ? k(a, c) : "#text" === a.nodeName ? l(a) : "#comment" === a.nodeName ? m(a) : "#cdata-section" === a.nodeName ? n(a) : void 0
                };
