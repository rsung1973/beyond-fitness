...
function LivIconsEvoDefaults () {
	...
	var default_options = {
		...
		pathToFolder: 'plugins/livIconsevo/svg/', //the path from root of your site to folder with icons. Also may be as URL, like 'http://yoursite.com/path/to/LivIconsEvo/svg/'
